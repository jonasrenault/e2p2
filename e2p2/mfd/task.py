...
def mfd(
    ...
    """
    Run formula detection on given pdf file.
    ...
    model = FormulaDetectionYOLO(device=device)

    # layout pdf
    layout_pdf(pdf, model, visualize, save_dir, img_size, conf, iou, task_name="MFD")
